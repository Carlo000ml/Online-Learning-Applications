...
class Enviroment:
    ...
    def round(self ,pulled_price_arm , pulled_bid_arm):
        ...
        # Generate quantities
        clicks=f.generate_num_of_cliks_given_bid( pulled_bid_arm , click_numb_params[0] ,click_numb_params[1] , click_numb_params[2] , 10 )
        cum_daily_cost=f.cumulative_cost_sample( pulled_bid_arm , cum_daily_cost_param , 10)
        ...
        to_return=(conversions,clicks,cum_daily_cost,reward)
