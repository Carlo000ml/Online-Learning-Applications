...
class GP_ts_1:
    def __init__(self, std,support):
        ...
        theta=1.0
        l=1.0
        kernel = C(theta, (1e-5, 1e7)) * RBF(l, (0.000001, 1e7))

        self.gp=GaussianProcessRegressor(kernel=kernel, alpha=std**2,optimizer="fmin_l_bfgs_b", normalize_y=False, n_restarts_optimizer=10)
