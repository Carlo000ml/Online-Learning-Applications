...
## for the number of clicks og the ucb1
...
class GP_ucb_1:
    def __init__(self, std,support):
        ...
        theta=10000    # 1 
        l=10000   # 1
        kernel = C(theta, (1e-5, 1e7)) * RBF(l, (0.08, 1e7))

        self.gp=GaussianProcessRegressor(kernel=kernel,optimizer="fmin_l_bfgs_b", alpha=std**2, normalize_y=False, n_restarts_optimizer=10)
