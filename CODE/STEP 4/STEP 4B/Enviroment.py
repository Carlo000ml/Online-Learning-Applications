...
class Enviroment:
    ...
    # class 3
        ...
        to_return={(1,1): [conversions_class_1 , click_class_1,cum_daily_cost_class_1,reward_class_1] , (0,1) : [conversions_class_2 , click_class_2,cum_daily_cost_class_2,reward_class_2] , (0,0) : [conversions_class_3 , click_class_3,cum_daily_cost_class_3,reward_class_3] }
